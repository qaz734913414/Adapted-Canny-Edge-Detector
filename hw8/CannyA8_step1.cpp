	...
	void main(void)
	{
	   ...
	   for(i=0; i<IMG_NUM; i++)
	   {
	      ...
	      ****************************************************************************/
	      ...
	      printf("%f s: Stimulus sent frame %d.\n", sentTime.to_double(), i);
	   }
	}
	...
	******************************************************************************/
	...
	void main(void)
	{
	   ...
	   for(i=0; i<IMG_NUM; i++)
	   {
	      ...
	      double timeDelay = receiveTime.to_double() - stimuTime.to_double();
	      printf("%f s: Monitor received frame %d with %f s delay.\n", receiveTime.to_double(), i, timeDelay);
       ...
       printf("%f s: Monitor exits simulation.\n", exitTime.to_double());
